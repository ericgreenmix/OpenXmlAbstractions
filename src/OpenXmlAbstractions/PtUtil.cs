...
{
    internal static class PtExtensions
    {
    ...
    internal class ReverseDocumentOrderInfo
    {
        public XElement PreviousSibling;
    }

    internal class GroupOfAdjacent<TSource, TKey> : IEnumerable<TSource>, IGrouping<TKey, TSource>
    {
