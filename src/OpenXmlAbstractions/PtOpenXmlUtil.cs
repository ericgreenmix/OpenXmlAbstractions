...
namespace OpenXmlAbstractions
{
    ...
    internal static class WPC
    {
        public static XNamespace wpc =
            "http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas";
    }

    internal static class WPG
    {
    ...
    internal static class PtOpenXml
    {
    ...
    internal static class PtOpenXmlExtensions
    {
    ...
    internal class InvalidOpenXmlDocumentException : Exception
    {
        public InvalidOpenXmlDocumentException(string message) : base(message) { }
    }

    internal class OpenXmlPowerToolsException : Exception
    {
